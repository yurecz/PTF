*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_V_PTF_VAR_TAG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_V_PTF_VAR_TAG       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_V_PTF_VAR_TAG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = V_PTF_VAR_TAG_EXTRACT
TOTAL = V_PTF_VAR_TAG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_V_PTF_VAR_TAG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_V_PTF_VAR_TAG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_PTF_VAR_TAG_EXTRACT
TOTAL = V_PTF_VAR_TAG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_V_PTF_VAR_TAG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_V_PTF_VAR_TAG'
...
TOTAL = V_PTF_VAR_TAG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_V_PTF_VAR_TAG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_V_PTF_VAR_TAG-UPD_FLAG NE SPACE.
