interface IF_PTF_BO_QUOT_DYNAMIC_CODE
  public .
  ...
  class-methods DYNAMIC_TEST_DATA_CHANGE
    ...
    changing
      !CS_QUOT_TEST_DATA type CL_PTF_BO_QUOT=>TY_GS_I_PTF_QUOT_CR_TD optional
    returning
  ...
  class-methods CUSTOM_DYNAMIC_CHECK
    ...
    exporting
      ...
      !EV_DOCUMENT_ID type CL_PTF_UTIL=>TY_VBELN_TAB
    changing
      !CS_QUOT_TEST_DATA type CL_PTF_BO_QUOT=>TY_GS_QUOT_CHECK_DATA optional
    returning
